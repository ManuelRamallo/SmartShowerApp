...
public class BluetoothActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //COMPROBACIÓN DE ENVÍO DE DATOS POR PREFERENCIAS
        SharedPreferences prefs = BluetoothActivity.this.getSharedPreferences("datos", Context.MODE_PRIVATE);
        //SharedPreferences.Editor editor = prefs.edit();

        String token = prefs.getString(PreferencesKeys.USER_TOKEN, "No hay token");
