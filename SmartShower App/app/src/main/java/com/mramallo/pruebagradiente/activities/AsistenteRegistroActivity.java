            ...
            public void onClick(View view) {
                ...
                if(((IAsistenteRegistro)currentFragment).validarPaso()) {
                    ...
                    final SharedPreferences.Editor editor = prefs.edit();
                        ...
                        final int limitConsum = Integer.parseInt(etLimitConsum.getText().toString());
                        ...
                        call.enqueue(new Callback<User>() {
                            ...
                            public void onResponse(Call<User> call, Response<User> response) {
                                ...
                                if (response.code() == HttpsURLConnection.HTTP_CREATED) {
                                    ...
                                    Toast.makeText(AsistenteRegistroActivity.this, "Error, email ya registrado", Toast.LENGTH_SHORT).show();
                                    Intent i = new Intent(AsistenteRegistroActivity.this, MainActivity.class);
                                    startActivity(i);
                                    finish();
                                }
                            }
